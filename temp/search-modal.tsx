...
// export function SearchModal({ isOpen, onClose, onNavigate, onDocumentSelect }: SearchModalProps) {
//   const {
//     query,
//     setQuery,
//     searchResults,
...
//       regex.test(part) ? (
//         <mark key={index} className="bg-blue-600/30 text-blue-300 rounded px-0.5">
//           {part}
//         </mark>
//       ) : (
//         part
...
//                     <span className="text-gray-300">View Starred Documents</span>
//                     <ArrowRight className="w-4 h-4 text-gray-500 ml-auto" />
//                   </button>
//                   <button
//                     onClick={() => {
...
//                     <span className="text-gray-300">Browse All Documents</span>
//                     <ArrowRight className="w-4 h-4 text-gray-500 ml-auto" />
//                   </button>
//                 </div>
//               </div>
...
//                               isSelected ? "bg-blue-600/20 border border-blue-500/30" : "hover:bg-[#1A1A1C]"
//                             }`}
//                           >
...
//                                   {highlightMatch(result.preview.replace(/[#*`\n]/g, " ").trim(), query)}
//                                 </p>
//                               )}
